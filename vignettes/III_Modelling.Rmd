...
vignette: >
  %\VignetteIndexEntry{GPoM : III Modelling}
...
is presented in vignette `V_Predictability`.
...
in vignette  `VII_Retromodelling`.
...
In other cases, equivalent records of the same dynamical behavior
may have been performed at different locations (concurently
or not) and it may be useful to considered these time
series simultaneously in the modelling process.
